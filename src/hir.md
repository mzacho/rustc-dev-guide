...
calls like [`tcx.hir().get_parent_item(n)`][get_parent_item].

[get_parent_item]: https://doc.rust-lang.org/nightly/nightly-rustc/rustc_middle/hir/map/struct.Map.html#method.get_parent_item
